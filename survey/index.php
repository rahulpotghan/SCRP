...
<html lang="en" class="no-js"><head>
		...
		<link rel="apple-touch-icon" href="http://<?=$_SERVER['HTTP_HOST']?>/apple-touch-icon.png">
		...
		<link rel="stylesheet" href="http://<?=$_SERVER['HTTP_HOST']?>/static/css/stylesheets/screen.css">

		<link rel="stylesheet" type="text/css" href="http://<?=$_SERVER['HTTP_HOST']?>/static/css/stylesheets/hira_navi.css" />
		<link rel="stylesheet" type="text/css" href="http://<?=$_SERVER['HTTP_HOST']?>/static/css/stylesheets/hira_l8.css" />

		<script src="http://<?=$_SERVER['HTTP_HOST']?>/js/hiranya_l8box.js"></script>
		<script src="http://<?=$_SERVER['HTTP_HOST']?>/js/hiranya_navi.js"></script>

		<script src="http://<?=$_SERVER['HTTP_HOST']?>/static/js/libs/modernizr-1.7.min.js"></script>
        <script src="http://<?=$_SERVER['HTTP_HOST']?>/static/js/login.js"></script>
        
        <script src="http://<?=$_SERVER['HTTP_HOST']?>/static/js/libs/jquery.jscrollpane.min.js"></script>
		...
		<section id="fine_tuning">
			...
			<div id="fine_tuning_content">
    			...
    			{{/if}}
					...
					<!--Le Fair Trade SLider code begins -->
					<div id="fine_tune_items">
					<ul style="positon:absolute; top:150px; height:200px;">
                    
                    
                    <li class="category"><span class="label" style="font-size:.75em">What % of items in this category are ethically sourced?</span></li>
                    <li id="item_slider"><span  class="controls-slider">
                    {{each tags}}
                    {{if tags[$index].attributes.product_name == "Fair Trade"}}
                    <div id="diamonds_slider_scope1" rel="${tags[$index].attributes.Tag_id}" class="sliderscope1 item1"></div>
                   <div rel="diamonds1" class="slider jewelry-slider_mask diamonds item"></div>
                    <div style="padding-bottom:5px"><span class="diamonds1_box1">0%</span><span class="diamonds1_box">${tags[$index].attributes.amount}%</span></div>
					</span></li>
                    {{/if}}
					 {{/each}}
                    
                    <li class="category"><span class="label">Question Items</span></li>
					...
					{{else}}
					{{if 'Fair Trade' != tags[$index].attributes.product_name }}
					<li id="item_${$index}">
					<span class="controls">
